...
try
{
    ...
    builder.Services.AddHealthChecks()
        .AddCheck<BankMore.Transferencia.Infrastructure.HealthChecks.DatabaseHealthCheck>("database")
        .AddCheck<BankMore.Transferencia.Infrastructure.HealthChecks.AccountServiceHealthCheck>("account-service");
